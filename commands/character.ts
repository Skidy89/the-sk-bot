...
import { MessageSerialize, UserType } from "../types";
...
los objetos que sean armas obtienen 20% de durabilidad extra
obtienes mas experiencia que con otro personaje
(pasiva) recupera su salud con el tiempo (5 horas para la salud maxima)
