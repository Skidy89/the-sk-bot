...
let randomChars = Math.random().toString(36).substring(2, 12)
...
export class WASticker {
  ...
  #$_createExif() {
    const data = JSON.stringify({
      ...
      "sticker-pack-publisher-email": "wutopjonh@gmail.com",
      "sticker-pack-publisher-website": "https://github.com/skidy89",
      ...
      "ios-app-store-link": "https://apps.apple.com/es/app/whatsapp-messenger/id310633997"
    })
